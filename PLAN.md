...
- **Backlog (explicitly cut from v1):** motion plane (new plane ID, no version bump), audio via a `Clock` trait impl, braille polish, zstd dictionaries, kitty-graphics `PixelPresenter`.
