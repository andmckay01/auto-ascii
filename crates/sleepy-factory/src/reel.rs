...
//!
//! `sleepy-factory eval --reel out.html` emits one self-contained HTML page:
...
use slpy_eval::{EdgeScore, GrayImage};
...
mod tests {
    ...
    fn reel_html_is_self_contained() {
        ...
        let html = render_reel_html(&[clip], "sleepy-factory test");
