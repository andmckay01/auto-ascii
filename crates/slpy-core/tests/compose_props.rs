...
use slpy_core::compose::{ComposeParams, FramePlanes, compose_frame};
use slpy_core::hysteresis::HysteresisState;
use slpy_core::palette::{ColorDepth, GlyphTier, select_palettes};
use slpy_core::{Cell, Grid, Rgb, compute_viewport, hysteresis_idx};
...
proptest! {
    ...
    fn uniform_input_is_pure_base_ramp(
        ...
        let idx = hysteresis_idx(
            n,
            set.base.len(),
            slpy_core::hysteresis::IDX_UNSET,
            slpy_core::hysteresis::IDX_HYST_Q8,
        );
