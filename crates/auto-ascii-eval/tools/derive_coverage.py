...
Method (glyphs rasterized into a 64×128 cell, coverage measured):
  ...
  (per-font tables are generated by `auto-ascii-factory font-table`).
  ...
  i.e. a 1:2 cell aspect matching the engine's default.
