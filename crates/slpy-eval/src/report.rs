...
//!   fields tolerate absence — same posture as the SLPY chunk registry).
...
pub struct EvalReport {
    ...
    /// Producing tool, e.g. `"slpy-eval 0.1.0"` — informational.
...
mod tests {
    ...
    use slpy_term::FrameStats;

    fn sample_report() -> EvalReport {
        let mut r = EvalReport::new("slpy-eval test");
        let stats =
